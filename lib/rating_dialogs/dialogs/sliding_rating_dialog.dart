...
class SlideRatingDialog extends StatefulWidget {
  ...
  final Function(int value)? buttonOnTap;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Image.asset("assets/images/i$starCount.png", height: 110.0),
              const SizedBox(height: 12.0, width: 0.0),
              Text(
                ...
                children: [
                  ...
                  Transform.translate(
                    ...
                    child: Draggable(
                      ...
                      feedback: poinerWid(),
                      childWhenDragging: SizedBox(width: 50, height: 50.0),
                      child: poinerWid(),
                    ),
                  ),
                ],
